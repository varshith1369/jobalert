...
import { RawScrapedJob, EducationLevel, JobCategory } from '../types/index.js';
...
export class Normalizer {
  ...
  public static detectEducation(text: string): EducationLevel {
  ...
  public static detectCategory(orgShortName: string, title: string): JobCategory {
  ...
  public static async ingestJobs(rawJobs: RawScrapedJob[]): Promise<{ added: number; updated: number; skipped: number }> {
    let added = 0;
    let updated = 0;
    let skipped = 0;
